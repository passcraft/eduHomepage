      ...
      {pathname === '/judicial' ? (
        <section className="relative overflow-hidden">
          ...
          <div className="relative w-full bg-purple-600 px-4 py-16 sm:px-6 sm:py-24 lg:py-0 lg:pr-0 2xl:mx-auto 2xl:max-w-screen-xl 2xl:rounded-l-5xl">
            <div className="relative order-2 mx-auto grid w-full max-w-2xl grid-cols-2 gap-3 sm:gap-6 lg:order-1 lg:max-w-none ">
              <Image
                src={dotsPurpleMess}
            ...
            <div className="order-1 flex flex-col justify-center lg:order-2 lg:py-36">
              ...
              <div className="my-8 flex flex-wrap justify-center gap-4">
                ...
                <InfoCard
                  ...
                  text={
                    '📚 Study materials, assignments, and exam papers prepared by High Court Advocates'
                  }
                />
                <InfoCard
                  icon="home"
                ...
                <InfoCard
                  ...
                  text={'📚 Personal mentorship and guidance to every student'}
                />
                <InfoCard
                  icon="calendar"
                  gradientColors={{
                ...
                <InfoCard
                  ...
                  text={
                    '🎯 Weekly exam practice for prelims and mains. Interview guidance by judges.'
                  }
                />
              </div>
            </div>
